...
class StoreUserController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages\admin\store_user\index',compact("storeusers","merchants"));
    }
    ...
    public function store(Request $request)
    {
            ...
            return redirect('/storeuser')->with('success','Store User Information Successfully Added!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $storeuser->save();
        return redirect('/storeuser')->with('success','Store User Information Successfully Updated!');
    }
