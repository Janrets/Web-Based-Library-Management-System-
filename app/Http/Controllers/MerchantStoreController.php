...
class MerchantStoreController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages\merchant\store\index',compact("stores","storeusers"));
    ...
    public function store(Request $request)
    {
        ...
        $store->save();
        return redirect('/merchant-store')->with('success','Store Information Successfully Added!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $store->save();
        return redirect('/merchant-store')->with('success','Store Information Successfully Updated!');
    }
    ...
    public function getAvailableWithdrawalOrders($store_id)
    {
        $data = DB::table('stores')
        ->select('stores.id as s_id','customers.last_name as c_lname','orders.id as o_id','orders.total_amount as o_tot_amt','orders.status as o_status','drivers.last_name as d_lname')
        ->join('orders','orders.store_id','=','stores.id')
        ...
        ->orderBy('orders.id', 'desc')
        ->where('stores.id',$store_id)
        ->where('orders.withdrawal_id','=',NULL)
