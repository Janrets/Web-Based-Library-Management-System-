...
class MerchantVoucherController extends Controller
{
    ...
    public function index()
    {
        ...
        $stores = Store::all();
        return view('pages\merchant\voucher\index',compact("vouchers","stores"));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/merchant-voucher')->with('success','Voucher Information Successfully Added!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $voucher->save();
        return redirect('/merchant-voucher')->with('success','Voucher Information Successfully Updated!');
    }
