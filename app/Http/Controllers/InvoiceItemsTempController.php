...
class InvoiceItemsTempController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        {
            $invoice_items_temp = new InvoiceItemsTemp;
                ...
                return response()->json([
                    'status'=>200,
                    'message'=>'Invoice Item Successfully.'
                ]);
        } }
    ...
    {
        $invoice_items_temps = InvoiceItemsTemp::findorFail($id);
    ...
    public function getItemList($user_id)
    {
        ...
        $data = DB::table('invoice_items_temps')
        ->select('*')
        ->join('services','services.id','=','invoice_items_temps.item_name')
         ->where('invoice_items_temps.user_id',$user_id)
        ->get();
