...
class ProductController extends Controller
{
    ...
    public function index()
    {
       ...
       ->where('categories.category_type', 1)
        ->get();
        return view('pages\admin\product\index',compact("products","stores","categories"));
    }
    ...
    public function store(Request $request)
    {
        ...
        $product->save();
        return redirect('/product')->with('success','Product Information Successfully Added!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $product->save();
        return redirect('/product')->with('success','Product Information Successfully Updated!');
    }
