                               ...
                               <div class="row">
                                  ...
                                  <div class="col-sm">
                                    ...
                                    <select class="form-select" aria-label="Default select example" name="type" id="type" >
                                                <option class="opt1" value="" disabled selected hidden>Select Type</option>
              ...
              <div class="tablesizes card-body table-responsive p-0" style="z-index: -99999">
                <table id="table_id" class="table table-head-fixed text-nowrap table-striped table-hover" style=" font-size:14px;">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td class="align-middle">{{$material ->isbn}}</td>
                      ...
                      <td class="align-middle">{{$material ->type}}</td>
                      <td class="align-middle">{{$material ->name}}</td>
                      <td class="align-middle">
                          {{-- update modal --}}
                          <button type="button" data-id="{{ $material->id }}" class="btn editbtn" style="background: none;
                          color: inherit;
                          border: none;
                          padding: 0;
                          font: inherit;
                                      ...
                                      <div class="modal-body">
                                        ...
                                        <div class="container">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <label for="isbn">ISBN</label>
                                                    <input type="text" class="form-control" name="isbn2" id="isbn2" placeholder="ISBN" required>
                                            ...
                                            <div class="row">
                                               ...
                                               <div class="col-sm">
                                                 <label for="category">Category</label>
                                                 <select class="form-select" aria-label="Default select example" name="category_id2" id="category_id2" >
                                                             <option class="opt1" value="" disabled selected hidden>Select Category</option>
                                                             @foreach($categories as $category)
                                                               <option value="{{$category->id}}">{{$category->name}}  </option>
                                                             @endforeach
                                             ...
                                             <div class="row">
                                               <div class="col-sm">
                                                 <label for="Title">Title</label>
                                                 <input type="text" class="form-control" name="title2" id="title2" placeholder="Title" required>

                                               </div>
                                               <div class="col-sm">
                                                 <label for="author">Author</label>
                                                 <input type="text" class="form-control" name="author2" id="author2" placeholder="Author" required>
