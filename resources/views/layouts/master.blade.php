...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-light-primary elevation-1" style="max-height: calc(100vh - 9rem);
    ...
    <center> <img src="{{ asset('admin/dist/img/liblogo.png') }}" alt="Library Management System"  style ="height:70px; width:100px;">
     </center> <span class="brand-text font-weight-light"></span>
    </a>
              ...
              <p>
                ...
                <li class="nav-item ">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                          <a href="/transaction/0" class="nav-link ">
                            <i class="fas fa-user-edit nav-icon"></i>
                            <p>Pending Request</p>
                          </a>
                        </li>
                        <li class="nav-item">
                          <a href="/transaction/1" class="nav-link ">
                            <i class="fas fa-user-edit nav-icon"></i>
                            <p>Approved</p>
                          </a>
                        </li>
                        <li class="nav-item">
                          <a href="/transaction/2" class="nav-link ">
                            <i class="fas fa-user-edit nav-icon"></i>
                            <p>Declined</p>
                          </a>
                        </li>
                        <li class="nav-item">
                          <a href="/transaction/3" class="nav-link ">
                            <i class="fas fa-user-edit nav-icon"></i>
                            <p>Issued</p>
                          </a>
                        </li>
                        <li class="nav-item">
                          <a href="/transaction/4" class="nav-link">
                            <i class="fas fa-user-edit nav-icon"></i>
                            <p>Returned</p>
                          </a>
                        </li>
